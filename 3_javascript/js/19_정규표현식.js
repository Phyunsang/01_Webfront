...
document.getElementById("btn1").addEventListener("click", () => {
    ...
    // 정규표현식 객체 생성
    const regExp1 = new RegExp("scripts");
...
document.getElementById("btn2").addEventListener("click", () => {
    ...
    // [adcd] : 문자열 내에 a,b,c,d 중 하나라도 일치하는 문자가 있는지 검새
    const regExp2 = /[adcd]/;
    ...
    //$ (달러) : 문자열의 끝을 의미
    const regExp4 = /group$/; // 문자열의 시작이 group인지 확인
...
document.getElementById("inputPno").addEventListener("ketup", (e) => {
